...
Thread::Sleep (bool finishing)
{
    ...
    //333333333333333333333333333333333333333333333333333333333333
        double prev_burst_time = this->get_burst_time();
        double new_burst_time = 0.5*(kernel->stats->totalTicks - this->get_start_time()) + 0.5*prev_burst_time;

        DEBUG(dbgExpr, "[D] Tick ["<< kernel->stats->totalTicks 
                << "]: Thread [" << this->getID() << "] update approximate burst time, from: ["
                << prev_burst_time <<"], add ["<< kernel->stats->totalTicks - this->get_start_time() 
                << "], to ["<< new_burst_time <<"]");
        
        nextThread->set_burst_time(new_burst_time);
        this->set_burst_time(this->get_burst_time() - (kernel->stats->totalTicks - this->get_start_time()));
    //333333333333333333333333333333333333333333333333333333333333
