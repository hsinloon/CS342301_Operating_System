...
public:
    ...
    bool Create(char *name, int initialSize, bool IsDir);
...
//555555555555555555555555555555555555555555
    bool CreateADirectory(char *name)
    {
        if(Create(name, 0, TRUE))
            return 1;
        else
            return -1;
    }
...
//555555555555555555555555555555555555555555
    int CreateAFile(char* name, int size)
    {
        if(Create(name, size, FALSE))
            return 1;
        else
            return -1;
    }
  ...
  OpenFileId OpenAFile(char *name) {
        OpenFile* Openfilepointer = Open(name);
        //cout << fileDescriptor << endl;
        if(Openfilepointer == NULL) return -1;
        else{
            for(int j = 0; j < 20; j++){
                if(fileDescriptorTable[j] == NULL){
                    fileDescriptorTable[j] = Openfilepointer;
                    //cout << j << endl;
                    return j;
                }
